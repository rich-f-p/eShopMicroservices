...
namespace OrderMicroservice.Infrastructure.Services
{
    ...
    {
        private readonly IShoppingCartRepositoryAsync shoppingCartRepo;
        private readonly IMapper mapper;

        public ShoppingCartServiceAsync(IShoppingCartRepositoryAsync shoppingCartRepo, IMapper mapper)
        {
